...
public class integrated2 {
    public static void main(String[] args) {
        ...
        String mysqlpath="set classpath=C:\\Users\\lenovo\\Downloads\\mysql.jar;";
        ...
        while (true) {
            ...
            switch (choice) {
                case "1":
                    runJavaClass("calculator31");
                    break;
                case "2":
                    runJavaClassWithDependency("FileDBExecutorAnyTable", mysqlpath);
                    break;
                case "3":
                    runJavaFXWithDependency(
                        "javafxmysql3",
                        "C:\\Users\\lenovo\\Downloads\\openjfx-21.0.7_windows-x64_bin-sdk\\javafx-sdk-21.0.7\\lib",
                        mysqlpath
                    );
                    break;
                case "4":
